    ...
    <main className="min-h-screen bg-slate-950 px-4 py-10 text-slate-100 sm:px-6 lg:px-8">
      <div className="mx-auto w-full max-w-xl rounded-[2rem] border border-white/10 bg-slate-900/90 p-10 shadow-glass backdrop-blur-xl">
        <div className="mb-8 space-y-3 text-center">
          <p className="text-sm uppercase tracking-[0.24em] text-sky-300/70">Create account</p>
          <h1 className="text-4xl font-semibold">Join the AI SQL workspace</h1>
          <p className="text-slate-400">Build SQL, analyze impact, and manage queries with AI guidance.</p>
        </div>
